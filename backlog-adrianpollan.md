...
|---|-------------|----------|-----------|--------------|----------|--------|
| A1 | Revisar H1 y encabezados de la home para incluir variaciones literales de "consultoría de restaurantes", "consultoría de hostelería", "consultoría gastronómica" y "consultor de hostelería" | Posicionar keywords de cabecera sin perder conversión | Alta | Ninguna | Bajo | ✅ Completado |
...
| B5 | Añadir contexto al claim "100+ negocios acompañados" | Blindar el claim ante visitantes escépticos | Media | Ninguna | Bajo | ✅ Completado |
