    ...
    <>
      ...
      <section className="bg-white py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="bg-cream-dark border border-navy/10 rounded-xl p-8 lg:p-12 max-w-3xl">
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="font-display text-navy text-4xl font-bold mb-1">4%</p>
              ...
              <div>
                ...
                <p className="font-display text-navy text-4xl font-bold mb-1">11%</p>
