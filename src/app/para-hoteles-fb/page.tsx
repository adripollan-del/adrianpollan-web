          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-4">
              {references.map((ref, i) => (
                <div key={i} className="bg-white border border-grafito/10 rounded-xl p-6 flex items-center justify-between">
                  <div>
                    <p className="font-display text-grafito text-lg font-semibold">{ref.name}</p>
          ...
          <div className="bg-white border border-grafito/10 rounded-xl p-8 lg:p-12 max-w-3xl">
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <p className="font-display text-grafito text-4xl font-bold mb-1">–8%</p>
              ...
              <div>
                ...
                <p className="font-display text-grafito text-4xl font-bold mb-1">+6%</p>
