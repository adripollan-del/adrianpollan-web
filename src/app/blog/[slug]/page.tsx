...
export default async function BlogPostPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* ── HERO ──────────────────────────────────────────────────── */}
      <section className="relative hero-grafito pt-40 pb-0 lg:pt-48 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          ...
          <div
            className="
              ...
              prose-headings:font-display prose-headings:text-grafito prose-headings:font-semibold prose-headings:leading-tight
          ...
          {/* Firma del autor */}
          <div className="mt-16 pt-10 border-t border-grafito/10 flex items-center gap-4">
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-10">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-5 bg-white border border-amber/30 rounded-xl p-6 lg:p-8">
              <div>
                ...
                <p className="font-display text-grafito text-lg font-semibold leading-snug">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {related.map((rel) => (
                <Link
                  key={rel.slug}
                  href={`/blog/${rel.slug}`}
                  className="group bg-white border border-grafito/10 rounded-xl p-6 hover:border-amber/50 transition-colors"
                >
                  <p className="font-body text-amber text-xs tracking-widest uppercase mb-3">{rel.category}</p>
                  <h3 className="font-display text-grafito text-lg font-semibold leading-tight group-hover:text-amber transition-colors mb-2">
                    {rel.title}
                  </h3>
      ...
      <section className="bg-white py-20 lg:py-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          ...
          <h2 className="font-display text-grafito text-3xl lg:text-4xl font-semibold mb-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <TrackingLink
              ...
              className="inline-flex items-center gap-2 px-8 py-4 btn-amber text-grafito text-sm font-semibold"
            ...
            <TrackingLink
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-body text-sm text-grafito/60 hover:text-grafito transition-colors"
