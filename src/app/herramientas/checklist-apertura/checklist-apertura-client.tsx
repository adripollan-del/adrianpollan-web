...
function EmailCapture({ completed, total, level, checkedIds }: { completed: number; total: number; level: string; checkedIds: string[] }) {
  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      >
        {status === "loading" ? "Enviando..." : "Recibir mi checklist por email"}
      </button>
  ...
  return (
    <section className="bg-white py-16 lg:py-24">
      <div className="max-w-3xl mx-auto px-6 lg:px-10">
                        ...
                        <div
                          className={`w-5 h-5 border flex-shrink-0 mt-0.5 flex items-center justify-center transition-colors ${
                            isChecked
                              ...
                              : "border-grafito/30 hover:border-amber/60"
                          }`}
                        >
        ...
        {/* Email capture — checklist apertura */}
        {count > 0 && (
          <div className="mt-8 border-l-4 border-amber bg-cream-dark p-6 rounded-r-xl">
            ...
            <p className="font-body text-grafito/70 text-sm mb-4">Te enviamos tu checklist completada para que puedas imprimirla y consultarla cuando quieras.</p>
