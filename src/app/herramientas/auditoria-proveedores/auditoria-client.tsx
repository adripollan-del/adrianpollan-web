      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-10">
        ...
        {count > 0 && (
          <div className="mt-8 border-l-4 border-amber bg-cream-dark p-6 rounded-r-xl">
            ...
            <p className="font-body text-grafito/70 text-sm mb-4">Te enviamos tu informe de auditoría con el nivel alcanzado y los puntos de mejora.</p>
