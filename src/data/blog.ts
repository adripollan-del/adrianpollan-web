...
export const blogPosts: BlogPost[] = [
  {
    slug: "que-es-el-revpash-restaurante-optimizar",
    title: "Qué es el RevPASH y cómo usarlo para optimizar tu restaurante",
    excerpt:
    ...
    body: `<p>Cuando entro en un restaurante a hacer una auditoría, una de las primeras preguntas que hago al dueño es cuánto factura. Me suele responder con seguridad. Luego le pregunto cuánto factura por hora y se queda pensando. Y cuando le pregunto cuánto factura por silla y por hora, la respuesta casi siempre es la misma: silencio o una cara de circunstancias. Y ahí está el problema. Porque la facturación total te dice si vas tirando, pero el <strong>RevPASH en un restaurante</strong> te dice si estás exprimiendo de verdad el activo que tienes.</p><p>El RevPASH (Revenue Per Available Seat Hour) es una métrica que viene del revenue management hotelero, adaptada a la restauración por Sheryl Kimes en Cornell hace ya bastantes años. En castellano sería algo así como ingreso por silla disponible y hora. Y aunque suene a indicador de manual, es una de las herramientas más útiles que conozco para detectar dónde estás dejando dinero encima de la mesa sin enterarte.</p><h2>Qué es exactamente el RevPASH en un restaurante</h2><p>La fórmula es simple: ingresos totales del servicio dividido entre el número de sillas disponibles multiplicado por las horas de servicio. Si tu restaurante tiene 50 sillas, abre cuatro horas para comidas y ese servicio factura 1.800 euros, tu RevPASH es de 9 euros por silla y hora.</p><p>Lo interesante no es el número en bruto. Lo interesante es lo que ese número contiene. Porque el RevPASH combina al mismo tiempo tres palancas que la mayoría de dueños miran por separado: el ticket medio, la rotación de mesas y la ocupación. Si tu RevPASH sube, alguna de las tres ha mejorado. Si baja, alguna se ha roto. Y cuando lo miras por franjas horarias, por día de la semana o por zona del local, empiezas a ver cosas que la cuenta de explotación nunca te va a enseñar.</p><h2>Por qué la facturación total te está engañando</h2><p>Conozco restaurantes que facturan 80.000 euros al mes y ganan poco. Y conozco restaurantes que facturan 45.000 y ganan más. La diferencia casi nunca está en la carta ni en el margen de cada plato. Está en cómo usan el espacio y el tiempo.</p><p>Imagina dos restaurantes idénticos en tamaño y carta. El primero tiene un ticket medio alto, de 38 euros, pero su rotación es lenta: las mesas se quedan dos horas y media. El segundo tiene un ticket medio de 28 euros, pero rota cada hora y veinte. El segundo está facturando más por silla y por hora, aunque el dueño del primero se pase el día presumiendo de su ticket medio en redes. El RevPASH es lo que te obliga a ver esa realidad.</p><p>Y aquí viene lo incómodo: muchos restauranteros toman decisiones que mejoran una palanca y destrozan otra sin darse cuenta. Suben los precios para mejorar el ticket medio, pero pierden ocupación. Meten un menú barato para llenar, pero se les hunde el ticket medio. Aceleran el servicio para rotar más, pero la experiencia se resiente y vuelve menos gente. Sin un indicador que integre las tres cosas, vas a ciegas.</p><h2>Cómo calcular el RevPASH paso a paso en tu restaurante</h2><p>Lo primero es definir bien las sillas disponibles. No es lo mismo el aforo total que las sillas que realmente puedes ocupar de forma operativa. Si tienes 60 sillas pero la barra no la usas para servir comida o tienes dos mesas que nunca sientas porque están pegadas al baño, esas no cuentan. Sé honesto con el dato. Yo suelo trabajar con sillas operativas reales, no con el aforo del cartel de bomberos.</p><p>Lo segundo es definir las horas de servicio. Aquí también hay matices. Si abres a las 13:00 pero la primera mesa entra a las 13:30, esa media hora penaliza tu RevPASH artificialmente. Y si cierras cocina a las 16:00 pero hay sobremesa hasta las 17:00, hay que decidir si esa hora cuenta como servicio o no. Mi recomendación: cuenta el tiempo en el que la mesa está generando ingresos potenciales, no el horario del rótulo.</p><p>Lo tercero es trocear el dato. Un RevPASH medio mensual no sirve para casi nada. Lo que sirve es el RevPASH del martes a las 14:00, el del viernes a las 21:30 y el del domingo a las 15:00. Ahí es donde aparecen las oportunidades reales.</p><h2>Cómo usar el RevPASH para tomar decisiones en tu restaurante</h2><p>Cuando empiezas a mirar el RevPASH por franjas, aparecen patrones que cambian la forma de gestionar. Te pongo casos reales con los que me he encontrado.</p><p>Un restaurante en el centro de Madrid con un RevPASH muy alto los jueves y viernes noche, y bajísimo los martes. La reacción habitual sería cerrar los martes. La decisión correcta, después de mirar los datos, fue cambiar la oferta del martes a un menú de mediodía más rápido orientado a oficinas cercanas. Subió el RevPASH del martes un 60% sin tocar el resto de la semana.</p><p>Otro caso: una marisquería con buen ticket medio pero RevPASH mediocre. El problema era la rotación. Las mesas se quedaban tres horas porque el servicio del segundo plato se retrasaba sistemáticamente veinte minutos. Arreglando el flujo de cocina, redujeron la duración media de la mesa a dos horas y diez. El RevPASH subió un 28% sin subir un euro la carta.</p><p>Tercer caso: un restaurante con terraza que en verano facturaba mucho, pero al calcular el RevPASH descubrieron que la terraza tenía un RevPASH más bajo que el interior porque las consumiciones eran sobre todo bebida con ticket bajo y la rotación era lenta. Cambiaron la carta de terraza para meter platos compartibles de mayor margen y subieron el indicador sin perder ambiente.</p><h2>Los errores más comunes al implantar el RevPASH</h2><p>El primer error es obsesionarse con subirlo a costa de la experiencia. Si aceleras el servicio para mejorar la rotación y los clientes se sienten echados, el indicador sube tres meses y se hunde el siguiente trimestre porque no vuelve nadie. El RevPASH es una foto operativa, no un objetivo religioso.</p><p>El segundo error es no acompañarlo de otros indicadores. El RevPASH solo te dice cuánto ingresas por silla y hora, no cuánto margen sacas. Un RevPASH alto con un food cost descontrolado sigue siendo un mal negocio. Por eso siempre lo cruzo con prime cost y con margen de contribución por plato.</p><p>El tercer error es calcularlo una vez y guardarlo en un cajón. El RevPASH cobra sentido cuando lo mides semana a semana y lo comparas. La tendencia te dice más que el valor absoluto. Si tu RevPASH lleva tres meses cayendo aunque la facturación se mantenga, hay un problema estructural que todavía no se ha manifestado en la caja, pero se va a manifestar pronto.</p><p>El cuarto error, y el más frecuente: pensar que es una métrica para restaurantes grandes o con sistemas sofisticados. No lo es. Con una hoja de cálculo, los tickets del TPV y diez minutos al día, cualquier restaurante de barrio puede empezar a medirlo mañana. Lo difícil no es el cálculo, es tomarse en serio lo que el número te está diciendo.</p><p><a href="https://diagnostico.adrianpollan.com">Haz el diagnóstico gratuito de tu restaurante →</a></p>`,
  },
  {
